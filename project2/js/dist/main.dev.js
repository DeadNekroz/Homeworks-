...
L.marker([[40.683471, -73.903071]]).addTo(map).bindPopup('customMarker').openPopup(); // L.marker([22.313208922495647, 114.17263361075162], {icon:customMarker}).addTo(map).bindPopup("Hong Kong").openPopup();
